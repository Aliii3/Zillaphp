...
/***/ "./src/scripts/widgets/sjb_override.js":
/*!*********************************************!*\
  !*** ./src/scripts/widgets/sjb_override.js ***!
  \*********************************************/
...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $('.jobpost-form .btn.btn-primary').on('click', function () {
      console.log('hi');
      setTimeout(function () {
        $('.jobpost-form').css('padding-top', '50px');
    ...
    $('.sjb-phone-number').on('input', function () {
      ...
      error_element.hide(); // Validate Phone Number
    ...
    $('.sjb-attachment').on('change', function () {
      ...
      error_element.text('');
      error_element.hide(); // Validate on File Attachment
      ...
      if (0 != file.get(0).files.length) {
         ...
         */
        var file_ext = file.val().split('.').pop().toLowerCase(); // All Allowed File Extensions

        var allowed_file_exts = application_form.allowed_extensions; // Settings File Extensions && Getting value From Script Localization

        var settings_file_exts = application_form.setting_extensions;
        var selected_file_exts = 'yes' === application_form.all_extensions_check || null == settings_file_exts ? allowed_file_exts : settings_file_exts; // File Extension Validation
    ...
    function sjb_is_attachment(event) {
      ...
      $(".sjb-attachment").each(function () {
        ...
        var is_required_class = element.hasClass("sjb-not-required"); // Set Error Indicator on Invalid Attachment
  ...
  var file = {
    maxlength: 20,
    // maximum length of filename before it's trimmed
...
/***/ 5:
/*!***************************************************!*\
  !*** multi ./src/scripts/widgets/sjb_override.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\Dev\xampp\htdocs\webkeyz\zilla-multiples\wp-content\themes\zilla-multiples\src\scripts\widgets\sjb_override.js */"./src/scripts/widgets/sjb_override.js");


/***/ })

/******/ });
//# sourceMappingURL=sjb_override.bundle.js.map