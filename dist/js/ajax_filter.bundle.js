...
(function ($) {
  ...
  $('#year_filter_blogs, #month_filter_blogs').on('change', function (e) {
	...
	/* 
	Commented By Ramy Nabil on 26-08-2024 as "DOMSubtreeModified" is already not supported now 
	*/
...
/*
	...
	*/
	...
	var targetNode = document.querySelector('.custom_pagination');
	...
	var callback = function(mutationsList, observer) {
		for (var mutation of mutationsList) {
			if (mutation.type === 'childList') {
				// The old existing code to handle the mutation
				$('.ajax_pagination li a').on('click', function (e) {
					console.log($(this));
					e.preventDefault(); // don't trigger page reload
