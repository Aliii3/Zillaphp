...
<div class="row justify-content-center">
	<div class="col-lg-8">
			<form class="jobpost-form" id="sjb-application-form" name="c-assignments-form"  enctype="multipart/form-data">
				<h3><?php echo apply_filters('sjb_job_application_form_title', esc_html__('Apply For', 'simple-job-board')); ?> <?php the_title() ?> </h3>
				<div class="row">
								...
								<div class="row align-items-center">
									...
									<div class="col-12 col-md-6 col-lg-4">
										...
										<div class="file_input">
											<input id="upload_cv" type="file" name="applicant_resume" id="applicant-resume" class="sjb-attachment wpcf7-form-control-wrap "' . apply_filters('sjb_resume_required', 'required="required"') . '>
											<span class="file_input_name">No File Chosen</span>
										</div>
										<span class="sjb-invalid-attachment validity-note field_error_message" id="file-error-message"></span>
										<span class="file_size_validation field_error_message"></span>
									</div>

									<div class="col-12 col-md-6 col-lg-8">
										<ul class="note_list">
											<li><span>Allowed file types:</span> PDF and DOCX .</li>
											<li><span>Max file size:</span> 2MB.</li>
										</ul>
									</div>
								</div>
							';
										...
										if (NULL != $keys):
											foreach ($keys as $key):
												if (substr($key, 0, 7) == 'jobapp_'):
													...
													$required_field_asterisk = isset($val['optional']) ? "checked" === $val['optional'] ? '' : "" : '';
													...
													switch ($val['type']) {
														...
														case 'text':
															echo '
																<div class="custom_input">
																	...
																	<input type="text" name="' . $name . '" class="' . $required_class . '" id="' . $id . '" ' . $is_required . '>
																</div>';
															break;
														...
														case 'email':
															echo '
																<div class="custom_input">
																	<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>
																	<input type="email" name="' . $name . '" class="form-control sjb-email-address ' . $required_class . '" id="' . $id . '" ' . $is_required . '>
																	<p class="sjb-invalid-email validity-note">' . esc_html__('A valid email address is required.', 'simple-job-board') . '</p>
																</div>
															';
															break;
														...
														case 'phone':
															echo '
																<div class="custom_input">
																	<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>
																	<input type="tel" name="' . $name . '" class="form-control sjb-phone-number sjb-numbers-only ' . $required_class . '" id="' . $id . '" ' . $is_required . '>
																	<p class="sjb-invalid-phone validity-note" id="' . $id . '-invalid-phone">' . esc_html__('A valid phone number is required.', 'simple-job-board') . ' </p>
																</div>
															';
															break;
															...
															if ($val['options'] != '') {
																echo '<div class="custom_input">
																	...
																	foreach ($options as $option) {
																		echo '
																			<label class="small">
																				<input type="radio" name="' . $name . '" class=" ' . $required_class . '" id="' . $id . '" value="' . $option . '"  ' . sjb_is_checked($i) . ' ' . $is_required . '>'
																				. $option .
																			'</label> ';
																		$i++;
																	}
															...
															if ($val['options'] != '') {
																echo '<div class="custom_input">
																	...
																	foreach ($options as $option) {
																		echo '
																			<label class="small">
																				<input type="checkbox" name="' . $name . '[]" class="' . $required_class . '" id="' . $id . '" value="' . $option . '"  ' . $i . ' ' . $is_required . '>'
																				. $option .
																			'</label>';
																		$i++;
																	}
													...
													switch ($val['type']) {
														...
														case 'text_area':
															echo '
																<div class="custom_input">
																	<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>
																	<textarea name="' . $name . '" class="' . $required_class . '" id="' . $id . '" ' . $is_required . '  cols="30" rows="15"></textarea>
																</div>
															';
															break;
													}
													...
													switch ($val['type']) {
														...
														case 'text_area':
															echo '
																<div class="custom_input">
																	<label for="' . $key . '">' . $label . $required_field_asterisk . '</label>
																	<textarea name="' . $name . '" class="' . $required_class . '" id="' . $id . '" ' . $is_required . '  cols="30" rows="5"></textarea>
																</div>
															';
															break;
													}
					...
					<?php if (0 === $total_sections) { ?>
						...
						<div class="form-group col-12" id="sjb-form-padding-button">
							<button class="btn btn-primary btn-icon-arrow_right app-submit" id="app_submit"><?php esc_html_e('Apply', 'simple-job-board'); ?></button>
						</div>
						<?php if ( 0 === $total_sections ) { ?>
						<!-- </div> -->
					<?php } ?>
