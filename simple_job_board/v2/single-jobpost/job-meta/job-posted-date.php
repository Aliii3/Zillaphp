...
<?php if ($job_posting_time = sjb_get_the_job_posting_time()) {
    ?>
	<li><img src="<?php echo THEME_DIR_URI . '/dist/images/icon-feather-calendar.svg' ?>" alt="Calender Icon"><?php printf( __('Posted %s ago', 'simple-job-board'), sjb_get_the_job_posting_time() ); ?></li>
<?php } ?>
<!-- ==================================================
End Job Posted Date -->
