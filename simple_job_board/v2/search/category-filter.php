...
if (sjb_is_category_filter()) {
    ...
    <!-- Category Filter-->
    <!-- <div class="sjb-search-categories <?php echo apply_filters( 'sjb_category_filter_class', 'col-12 col-lg-3' ); ?>"> -->
		<!-- <div class="col-lg-3"> -->
			<div class="form-group col-12 col-lg-3">
				<label for="category"><?php esc_html_e('Business Lines', 'simple-job-board'); ?></label>
				<?php
