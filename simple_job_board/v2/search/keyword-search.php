...
if ( sjb_is_keyword_search() ) {
    $class = sjb_is_filter_dropdowns() ? 'col-12 col-lg-10' : 'col-12 col-lg-10';
    ?>
	...
	<!-- <div class="col-12"> -->
        <div class="form-group col-12 col-lg-10">
            ...
            <?php } ?>
            <label class="sr-only" for="keywords"><?php esc_html_e('Search with keywords', 'simple-job-board'); ?></label>
            <input type="text" class="form-control" value="<?php echo esc_attr( strip_tags( $search_keyword ) ); ?>" placeholder="<?php _e('Search with keywords', 'simple-job-board'); ?>" id="keywords" name="search_keywords">
        </div>
	<!-- </div> -->
    <!-- </div> -->
    <?php
