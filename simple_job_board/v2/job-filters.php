...
<!-- <div class="<?php echo apply_filters('filters_form_class', $class); ?> sjb-filters-v2"> -->
     ...
     */
    ?>
    <form class="filters-form row align-items-center justify-content-center" action="<?php echo apply_filters('sjb_job_filters_form_action', esc_url(home_url('/')) . $slug); ?>" method="<?php echo apply_filters('sjb_job_filters_form_method', 'get'); ?>">
