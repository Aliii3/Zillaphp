...
function enqueue_styles() {
	...
	if(is_singular('insights')){
		...
		wp_enqueue_style( 'single_insight_share', THEME_DIR_URI .'/dist/css/share.css', array(), '1', 'all' );
		wp_enqueue_style( 'single_insight_fonts', THEME_DIR_URI .'/dist/css/fonts.css', array(), '1', 'all' );
	}

	if(is_singular('reports')){
		wp_enqueue_style( 'flashnote_style', THEME_DIR_URI .'/dist/css/flashnote.css', array(), '1', 'all' );
	}
	if(is_page_template('assetmanagement.php')){
		wp_enqueue_style( 'am_products_style', THEME_DIR_URI .'/dist/css/am-products.css', array(), '1', 'all' );
	}
...
})(window,document,'script','dataLayer','GTM-5BJHVDH2');
</script>
...
<noscript>
<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5BJHVDH2"
